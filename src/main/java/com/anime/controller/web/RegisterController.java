...
public class RegisterController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (newUser.getPassword().equals(newUser.getRepassword()) && (userService.findByUserName(newUser.getUserName()) == false)) {
	            ...
	            response.sendRedirect(request.getContextPath() + "/dang-ki?&message=password_repassword_invalid&alert=danger");
	        }
	}
